...
*For students downloading the file directly from Ilias you do not need to run this.
*European Social Survey (ESS) data Cumulative File (ESS1-7e01.dta) 
*downloaded from http://www.europeansocialsurvey.org/downloadwizard/, on 18.02.2018
